...
#-------------------------------------------------------------------#
years <- as.numeric(names(table(data.wo$Time)))
countries <- names(table(data.wo$LocID))
...
for (i in 1:nrow(ineq.men)){
  ineq.men[i, 3] <- unique(data.wo$Location[data.wo$Time == ineq.men$year[i] 
                                             & data.wo$LocID == ineq.men$id[i]])
  ineq.men[i, 4] <- unique(data.wo$ISO3_code[data.wo$Time == ineq.men$year[i] 
                                              & data.wo$LocID == ineq.men$id[i]])
  dens.data <- data.wo$dx[data.wo$Time == ineq.men$year[i] &
                             data.wo$LocID == ineq.men$id[i]]/100000
...
for (i in 1:nrow(ineq.men)){
  ineq.men.t[i, 3] <- unique(data.wo$Location[data.wo$Time == ineq.men$year[i] 
                                               & data.wo$LocID == ineq.men$id[i]])
  data.temp <- data.wo$dx[data.wo$Time == ineq.men$year[i] &
                             data.wo$LocID == ineq.men$id[i]]/100000
